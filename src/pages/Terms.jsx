    ...
    <div className="max-w-4xl mx-auto px-6 py-24 min-h-screen">
      ...
      <div className="space-y-8 font-sans text-white/80 leading-relaxed">
        ...
        <section>
          ...
          <p>Each package standardly does not include free revisions unless specified. Any extra revisions requested post-delivery will incur a flat fee of ₹500 per revision round, to be billed separately.</p>
        </section>

        <section>
          <h2 className="text-xl text-white mb-4">4. Payment Terms</h2>
          <p>All payments must be made securely via our integrated payment gateway. We require full upfront payment for packages below ₹10,000. For custom/long-term contracts, milestone-based payments apply. Late invoices incur a 5% monthly fee.</p>
        </section>
