...
export default function Services() {
  ...
  const photoPackages = [
    { title: 'Basic Edit', desc: 'Standard retouching and color correction for precision consistency.', price: 15, unit: '/ image', details: [{label: 'Deliverables', value: 'High-res JPEGs/PNGs'}, {label: 'Features', value: 'Color correction, exposure balance'}, {label: 'What\'s included', value: '1 round of revisions'}, {label: 'Benefits', value: 'Consistent brand look'}] },
    { title: 'Advanced Manipulation', desc: 'Complex composites, skin retouching, and VFX integration.', price: 30, unit: '/ image', details: [{label: 'Deliverables', value: 'Multi-layer PSDs & high-res exports'}, {label: 'Features', value: 'Object removal, skin smoothing, composites'}, {label: 'What\'s included', value: '2 rounds of revisions'}, {label: 'Benefits', value: 'Flawless, high-end commercial quality'}] },
    { title: 'Campaign Bulk (10+)', desc: 'Engineered preset grading designed explicitly for huge campaign rollouts.', price: 10, unit: '/ image', details: [{label: 'Deliverables', value: 'Batch processed high-res images'}, {label: 'Features', value: 'Custom engineered presets'}, {label: 'What\'s included', value: 'Priority delivery'}, {label: 'Benefits', value: 'Perfect consistency across massive campaigns'}] }
  ];

  const webPackages = [
    { title: 'Landing Page', desc: 'High-conversion, performance-driven single page build optimized for strict ROAS.', price: 300, unit: ' minimum', details: [{label: 'Deliverables', value: 'Single page build'}, {label: 'Features', value: 'Responsive design, basic SEO'}, {label: 'What\'s included', value: 'Copy integration, form setup'}, {label: 'Benefits', value: 'Rapid deployment, focused conversion'}] },
    { title: 'Multi-Page Website', desc: 'Comprehensive structure parsing, seamless animations, and integrated CMS backend.', price: 800, unit: ' starting', details: [{label: 'Deliverables', value: 'Up to 5 pages + CMS integration'}, {label: 'Features', value: 'Advanced animations, custom routing'}, {label: 'What\'s included', value: 'Content management system setup'}, {label: 'Benefits', value: 'Scalable architecture for growing brands'}] },
    { title: 'Premium Platform', desc: 'Custom robust agency-level build utilizing experimental logic architectures.', price: 2000, unit: ' starting', details: [{label: 'Deliverables', value: 'Full custom web application'}, {label: 'Features', value: 'Complex state, database integration'}, {label: 'What\'s included', value: 'Performance optimization, analytics'}, {label: 'Benefits', value: 'Enterprise-grade performance and design'}] }
  ];

  const socialPackages = [
    { title: 'Starter', desc: 'Standard strategic scheduling and brand formulation execution.', price: 500, unit: '/ month', details: [{label: 'Deliverables', value: '12 posts per month'}, {label: 'Features', value: 'Content calendar, basic copy'}, {label: 'What\'s included', value: 'Monthly strategy call'}, {label: 'Benefits', value: 'Consistent active presence'}] },
    { title: 'Growth Engine', desc: 'Heavy trend analysis mixed with precision community engagement and targeting.', price: 1200, unit: '/ month', details: [{label: 'Deliverables', value: '20 posts + 5 Reels/Shorts per month'}, {label: 'Features', value: 'Trend capitalization, community management'}, {label: 'What\'s included', value: 'Bi-weekly analytics review'}, {label: 'Benefits', value: 'Rapid audience growth and high engagement'}] },
    { title: 'Premium Scale', desc: 'Complete omnipresence pipeline, deep analytics, and relentless performance tuning.', price: 2000, unit: '/ month', details: [{label: 'Deliverables', value: 'Daily posts + 15 Reels/Shorts per month'}, {label: 'Features', value: 'Omni-channel distribution, viral hook engineering'}, {label: 'What\'s included', value: 'Weekly strategy syncs, VIP support'}, {label: 'Benefits', value: 'Total market domination and explosive scaling'}] }
  ];
